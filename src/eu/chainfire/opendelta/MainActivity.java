...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mZenxLogo = (ImageView) findViewById(R.id.zenx_logo);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (UpdateService.STATE_ERROR_DISK_SPACE.equals(state)) {
                ...
                extraText = getString(R.string.error_disk_space_sub, current,
                        total);
                DrawableCompat.setTint(mZenxLogo.getDrawable(), ContextCompat.getColor(context, R.color.logo_err));
                ...
                DrawableCompat.setTint(mZenxLogo.getDrawable(), ContextCompat.getColor(context, R.color.logo_disabled));
                ...
                DrawableCompat.setTint(mZenxLogo.getDrawable(), ContextCompat.getColor(context, R.color.logo_green));
